...
interface Props {
  data: InsightReportResponse;
}

const InsightResultCompareCard: React.FC<Props> = ({ data }) => {
...
export default InsightResultCompareCard;
